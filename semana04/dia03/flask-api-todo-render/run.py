...
db = SQLAlchemy()
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://jnato_todolist:G2rzqqhPwWWr62v44RKkKbzEuxPriUAm@dpg-cjapaijbq8nc73ce6smg-a.oregon-postgres.render.com/db_todolist_m72a"
db.init_app(app)
