const ProductCard = ({ product }) => {
  ...
  return (
    <article className="cf-sm-4 cf-md-4 cf-lg-4 col-xs-4 col-sm-4 col-md-4 col-lg-4 sectgl-item">
      <div className="sectgl prod-i inner card card:hover">
      <span className="pricing">
        ...
        <div className="prod-i-bot">
          <div className="prod-i-info">
            <p className="prod-i-price">S/{price}</p>
            <p className="prod-i-categ"><a href="catalog-gallery.html">Desde</a></p>
          </div>
          <h3 className="prod-i-ttl"><a href="product.html">{name}</a></h3>
          <div className="btn-conteiner">
            <button className=" btn-content btn-content:hover btn-content:focus btn-content icon-arrow btn-content:hover icon-arrow arrow-icon-two btn-content:hover arrow-icon-three btn-content:hover arrow-icon-one btn-content:hover arrow-icon-two" href="#">Agregar <span class="icon-arrow">
